...
public class HorizontalCardHolder : MonoBehaviour
{
    ...
    void Swap(int index)
    {
        ...
        selectedCard.transform.SetParent(crossedParent, true);
        selectedCard.RefreshDragParentAfterSwap();
    ...
    public void ForceSelectCard(Card card)
    {
        if (card == null)
            return;
        ...
        foreach (var otherCard in cards)
        {
            ...
            if (otherCard.selected)
                otherCard.SetSelectedState(false);
        }
